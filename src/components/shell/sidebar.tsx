    ...
    <>
      ...
      <div className="sm:hidden fixed top-0 left-0 right-0 z-50 bg-[var(--sidebar)] border-b border-[var(--sidebar-border)] px-4 py-3">
        <div className="flex items-center justify-between">
          <h1 className="text-lg font-semibold text-[var(--sidebar-foreground)]">{org.name}</h1>
          <Button
            variant="ghost"
            size="sm"
      ...
      <div className={cn(
        ...
        <div className="flex flex-col h-full">
          {/* Header */}
          <div className="flex items-center px-6 py-4 border-b border-[var(--sidebar-border)]">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="w-8 h-8 bg-[var(--sidebar-primary)] rounded-[var(--radius-md)] flex items-center justify-center">
                  <span className="text-[var(--sidebar-primary-foreground)] font-bold text-sm">M</span>
                </div>
              </div>
              <div className="ml-3">
                <h1 className="text-lg font-semibold text-[var(--sidebar-foreground)]">Madrasah OS</h1>
