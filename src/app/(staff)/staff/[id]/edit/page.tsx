      ...
      <div className="space-y-6">
        ...
        <div className="max-w-4xl">
          <div className="text-center py-12">
            <h3 className="text-lg font-medium text-[var(--foreground)] mb-2">Staff member not found</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--muted-foreground)]">Update staff member information and permissions</p>
      </div>
