...
function SignUpForm() {
  ...
  // Define onboarding steps with form embedded in first step
  const onboardingSteps = [
    ...
    },
    {
      ...
      description: isNewOrgSetup 
        ? 'Add your organization\'s address, contact information, and other required details.'
        : 'Your organization details are already set up.',
      completed: !isNewOrgSetup,
    },
    {
      id: 'classes',
      title: 'Set up classes',
      description: 'Create classes and define schedules for your students.',
      completed: false,
    },
    {
      id: 'students',
      title: 'Add students',
      description: 'Import or manually add students to your organization.',
      completed: false,
    },
    {
      id: 'staff',
      title: 'Invite staff',
      description: 'Add teachers and administrators to help manage your organization.',
      completed: false,
    },
    {
      id: 'settings',
      title: 'Configure settings',
      description: 'Customize payment methods, notifications, and other preferences.',
      completed: false,
    },
  ]
